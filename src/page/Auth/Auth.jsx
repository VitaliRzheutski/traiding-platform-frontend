...
export const Auth = () => {
    ...
    return (
        <div className='h-screen realtive authContainer'>

            <div className='abslolute top-0 right-0 left-0
             bottom-0 bg-[#030712] bg-opacity-50'>
                ...
                bg-opacity-50 shadow-2xl shadow-white px-10' >
                    ...
                    <h1 className="text-6xl font-bold pb-9"> RZH Tread</h1>
                    ...
                    {location.pathname == "/signup" ? <section className="w-full">
                        ...
                        location.pathname == "/forgot-password"
                            ? <section className="w-full"><ForgotPasswordForm />
